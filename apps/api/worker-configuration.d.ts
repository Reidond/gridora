/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/api/wrangler.jsonc apps/api/worker-configuration.d.ts` (hash: ab42c3ab8c1b0d90976658dcedac5f1d)
...
interface __BaseEnv_Env {
	...
	NOTIFICATIONS: Queue;
	PROVIDER_KEK_V1: SecretsStoreSecret;
	PROVIDER_KEK_V2: SecretsStoreSecret;
	CLOUDFLARE_TUNNEL_API_TOKEN: SecretsStoreSecret;
	CLOUDFLARE_DNS_API_TOKEN: SecretsStoreSecret;
	AGENT_COMMAND_SIGNING_KEY: SecretsStoreSecret;
	ACCESS_ISSUER: "https://your-team.cloudflareaccess.com";
	ACCESS_AUDIENCE: "replace-with-access-application-audience";
	...
	CLOUDFLARE_DNS_ZONE_ID: "replace-with-cloudflare-dns-zone-id";
	NODE_REGISTRATION_TOKEN_KEY_VERSION: "1";
	CONTROL_PLANE_URL: "https://api.gridora.example/";
	AGENT_VERSION: "0.1.0";
	AGENT_COMMAND_SIGNING_PUBLIC_KEY_PEM: "replace-with-ed25519-public-key-pem";
	NODE_BOOTSTRAP_TTL_SECONDS: "900";
	NODE_IMAGE_TRUSTED_PUBLIC_KEY_DIGESTS: "replace-with-comma-separated-sha256-public-key-digests";
	INTERNAL_SERVICE_SECRET: string;
	SERVER_PROVISION_COMMERCIAL_REVIEW_SECRET: string;
	...
	RESOURCE_OPERATION: DurableObjectNamespace /* ResourceOperationDO from gridora-realtime */;
	ORGANIZATION_EVENTS: DurableObjectNamespace /* OrganizationEventsDO from gridora-realtime */;
	INTERNAL_REPLAY_GUARD: DurableObjectNamespace /* InternalReplayGuardDO from gridora-realtime */;
	AUTH_INTENT_RATE_LIMIT: DurableObjectNamespace /* AuthIntentRateLimitDO from gridora-realtime */;
	AUTH_INTENT_STATE: DurableObjectNamespace /* AuthIntentStateDO from gridora-realtime */;
	NODE_COORDINATOR: DurableObjectNamespace /* NodeCoordinatorDO from gridora-realtime */;
	LIVE_LOG_STREAM: DurableObjectNamespace /* LiveLogStreamDO from gridora-realtime */;
	DELETE_ORGANIZATION: Workflow /* DeleteOrganizationWorkflow from gridora-workflows */;
	PROVISION_NODE: Workflow /* ProvisionNodeWorkflow from gridora-workflows */;
	SERVER_PROVISION_PLAN: Workflow /* ServerProvisionPlanWorkflow from gridora-workflows */;
	REBUILD_NODE: Workflow /* RebuildNodeWorkflow from gridora-workflows */;
	RETIRE_NODE: Workflow /* RetireNodeWorkflow from gridora-workflows */;
	DRAIN_NODE: Workflow /* DrainNodeWorkflow from gridora-workflows */;
	LEAVE_DRAIN_NODE: Workflow /* LeaveDrainNodeWorkflow from gridora-workflows */;
	NODE_RUNTIME_LIFECYCLE: Workflow /* NodeRuntimeLifecycleWorkflow from gridora-workflows */;
	NODE_IMAGE_LIFECYCLE: Workflow /* NodeImageLifecycleWorkflow from gridora-workflows */;
	DEPLOY_GAME_SERVER: Workflow /* DeployGameServerWorkflow from gridora-workflows */;
	START_GAME_SERVER: Workflow /* StartGameServerWorkflow from gridora-workflows */;
	STOP_GAME_SERVER: Workflow /* StopGameServerWorkflow from gridora-workflows */;
	RESTART_GAME_SERVER: Workflow /* RestartGameServerWorkflow from gridora-workflows */;
	UPDATE_GAME_SERVER: Workflow /* UpdateGameServerWorkflow from gridora-workflows */;
	APPLY_GAME_CONFIG: Workflow /* ApplyGameConfigWorkflow from gridora-workflows */;
	SYNC_MODS: Workflow /* SyncModsWorkflow from gridora-workflows */;
	BACKUP_GAME_SERVER: Workflow /* BackupGameServerWorkflow from gridora-workflows */;
	RESTORE_GAME_SERVER: Workflow /* RestoreGameServerWorkflow from gridora-workflows */;
	MOVE_GAME_SERVER: Workflow /* MoveGameServerWorkflow from gridora-workflows */;
	DELETE_GAME_SERVER: Workflow /* DeleteGameServerWorkflow from gridora-workflows */;
	REGISTER_PROVIDER_IMAGE: Workflow /* RegisterProviderImageWorkflow from gridora-workflows */;
	RECONCILE_ORPHAN: Workflow /* ReconcileOrphanWorkflow from gridora-workflows */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_ISSUER" | "ACCESS_AUDIENCE" | "PUBLIC_APP_ORIGIN" | "CONSOLE_ORIGIN" | "INVITATION_TOKEN_KEY_VERSION" | "PROVIDER_KEK_ACTIVE_VERSION" | "PROVIDER_BYOP_ENABLED" | "REGISTRATION_MODE" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DNS_ZONE_ID" | "NODE_REGISTRATION_TOKEN_KEY_VERSION" | "CONTROL_PLANE_URL" | "AGENT_VERSION" | "AGENT_COMMAND_SIGNING_PUBLIC_KEY_PEM" | "NODE_BOOTSTRAP_TTL_SECONDS" | "NODE_IMAGE_TRUSTED_PUBLIC_KEY_DIGESTS" | "INTERNAL_SERVICE_SECRET" | "SERVER_PROVISION_COMMERCIAL_REVIEW_SECRET" | "REALTIME_TICKET_SECRET" | "INVITATION_TOKEN_SECRET" | "NODE_CREDENTIAL_SECRET" | "NODE_REGISTRATION_TOKEN_SECRET">> {}
}
