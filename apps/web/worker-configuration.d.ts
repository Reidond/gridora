/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/web/wrangler.jsonc apps/web/worker-configuration.d.ts` (hash: ad2fbc9a662caf87362c5025dfc6e3fa)
