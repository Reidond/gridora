/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/queue-consumers/wrangler.jsonc workers/queue-consumers/worker-configuration.d.ts` (hash: 3e3cd64fab9c20537669b7d7dbef983e)
