/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/queue-consumers/wrangler.jsonc` (hash: 5dffb8fab6ed47c4d741b915b44e4b6d)
...
interface __BaseEnv_Env {
	...
	DB: D1Database;
	INVITATION_EMAIL: SendEmail;
	RECONCILIATION_QUEUE: Queue;
	POLICY_RECONCILIATION_QUEUE: Queue;
	AUDIT_EXPORT: Queue;
	...
	RECONCILE_POLICY: Workflow /* ReconcilePolicyWorkflow from gridora-workflows */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/queue-consumers/src/index");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INVITATION_TOKEN_KEY_VERSION" | "PUBLIC_APP_URL" | "INVITATION_EMAIL_FROM" | "INTERNAL_SERVICE_SECRET" | "INVITATION_TOKEN_SECRET">> {}
}
