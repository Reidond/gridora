/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/web/wrangler.jsonc apps/web/worker-configuration.d.ts` (hash: 1c5e7920f2bf9bcb580dc169f3fbeffc)
// Runtime types generated with workerd@1.20260820.1 2026-08-23 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	NUXT_PUBLIC_API_BASE: "https://api.gridora.example";
	NUXT_PUBLIC_DATA_MODE: "api";
	NUXT_PUBLIC_ACCESS_COMPLETION_URL: "https://console.gridora.example/auth/complete";
	NUXT_PUBLIC_PUBLIC_APP_ORIGIN: "https://app.gridora.example";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUXT_PUBLIC_API_BASE" | "NUXT_PUBLIC_DATA_MODE" | "NUXT_PUBLIC_ACCESS_COMPLETION_URL" | "NUXT_PUBLIC_PUBLIC_APP_ORIGIN">> {}
}
