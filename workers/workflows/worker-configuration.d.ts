/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/workflows/wrangler.jsonc workers/workflows/worker-configuration.d.ts` (hash: 433cf781474ef3fe451fb3938ebbb467)
...
interface __BaseEnv_Env {
	...
	APPLICATION: Fetcher /* gridora-api */;
	DELETE_ORGANIZATION: Workflow<Parameters<import("./src/index").DeleteOrganizationWorkflow['run']>[0]['payload']>;
	PROVISION_NODE: Workflow<Parameters<import("./src/index").ProvisionNodeWorkflow['run']>[0]['payload']>;
	SERVER_PROVISION_PLAN: Workflow<Parameters<import("./src/index").ServerProvisionPlanWorkflow['run']>[0]['payload']>;
	REBUILD_NODE: Workflow<Parameters<import("./src/index").RebuildNodeWorkflow['run']>[0]['payload']>;
	RETIRE_NODE: Workflow<Parameters<import("./src/index").RetireNodeWorkflow['run']>[0]['payload']>;
	DRAIN_NODE: Workflow<Parameters<import("./src/index").DrainNodeWorkflow['run']>[0]['payload']>;
	LEAVE_DRAIN_NODE: Workflow<Parameters<import("./src/index").LeaveDrainNodeWorkflow['run']>[0]['payload']>;
	NODE_RUNTIME_LIFECYCLE: Workflow<Parameters<import("./src/index").NodeRuntimeLifecycleWorkflow['run']>[0]['payload']>;
	NODE_IMAGE_LIFECYCLE: Workflow<Parameters<import("./src/index").NodeImageLifecycleWorkflow['run']>[0]['payload']>;
	DEPLOY_GAME_SERVER: Workflow<Parameters<import("./src/index").DeployGameServerWorkflow['run']>[0]['payload']>;
	START_GAME_SERVER: Workflow<Parameters<import("./src/index").StartGameServerWorkflow['run']>[0]['payload']>;
	STOP_GAME_SERVER: Workflow<Parameters<import("./src/index").StopGameServerWorkflow['run']>[0]['payload']>;
	RESTART_GAME_SERVER: Workflow<Parameters<import("./src/index").RestartGameServerWorkflow['run']>[0]['payload']>;
	UPDATE_GAME_SERVER: Workflow<Parameters<import("./src/index").UpdateGameServerWorkflow['run']>[0]['payload']>;
	APPLY_GAME_CONFIG: Workflow<Parameters<import("./src/index").ApplyGameConfigWorkflow['run']>[0]['payload']>;
	SYNC_MODS: Workflow<Parameters<import("./src/index").SyncModsWorkflow['run']>[0]['payload']>;
	BACKUP_GAME_SERVER: Workflow<Parameters<import("./src/index").BackupGameServerWorkflow['run']>[0]['payload']>;
	RESTORE_GAME_SERVER: Workflow<Parameters<import("./src/index").RestoreGameServerWorkflow['run']>[0]['payload']>;
	MOVE_GAME_SERVER: Workflow<Parameters<import("./src/index").MoveGameServerWorkflow['run']>[0]['payload']>;
	DELETE_GAME_SERVER: Workflow<Parameters<import("./src/index").DeleteGameServerWorkflow['run']>[0]['payload']>;
	REGISTER_PROVIDER_IMAGE: Workflow<Parameters<import("./src/index").RegisterProviderImageWorkflow['run']>[0]['payload']>;
	RECONCILE_ORPHAN: Workflow<Parameters<import("./src/index").ReconcileOrphanWorkflow['run']>[0]['payload']>;
	RECONCILE_POLICY: Workflow<Parameters<import("./src/index").ReconcilePolicyWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INTERNAL_SERVICE_SECRET">> {}
}
