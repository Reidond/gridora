/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/realtime/wrangler.jsonc workers/realtime/worker-configuration.d.ts` (hash: b44de93937af710ba2a88ea81cb9f441)
// Runtime types generated with workerd@1.20260820.1 2026-08-23 nodejs_compat
interface __BaseEnv_Env {
	REALTIME_TICKET_SECRET: string;
	NODE_COORDINATOR: DurableObjectNamespace<import("./src/index").NodeCoordinatorDO>;
	RESOURCE_OPERATION: DurableObjectNamespace<import("./src/index").ResourceOperationDO>;
	ORGANIZATION_EVENTS: DurableObjectNamespace<import("./src/index").OrganizationEventsDO>;
	LIVE_LOG_STREAM: DurableObjectNamespace<import("./src/index").LiveLogStreamDO>;
	INTERNAL_REPLAY_GUARD: DurableObjectNamespace<import("./src/index").InternalReplayGuardDO>;
	AUTH_INTENT_RATE_LIMIT: DurableObjectNamespace<import("./src/index").AuthIntentRateLimitDO>;
	AUTH_INTENT_STATE: DurableObjectNamespace<import("./src/index").AuthIntentStateDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "NodeCoordinatorDO" | "ResourceOperationDO" | "OrganizationEventsDO" | "InternalReplayGuardDO" | "AuthIntentStateDO" | "AuthIntentRateLimitDO" | "LiveLogStreamDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REALTIME_TICKET_SECRET">> {}
}
