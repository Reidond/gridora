/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=infra/cloudflare/wrangler.template.jsonc infra/cloudflare/worker-configuration.d.ts` (hash: 1e676782ed77e8eb94d8cc29262cba4a)
